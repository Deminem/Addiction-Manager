           ...
           ///////// ///////////
			...
			try
			{
				...
				//
                                ...
                                if (e.getMessage().equalsIgnoreCase("Connection refused")){
                                    String msg=("\nADDICTION MANAGER REDIRECT!!!!\n---------------------------------------------"
                                            + "\nyou are  not supposed to be opening "+distraction+"\n");
                                    clientOut.write(msg.getBytes(),0,msg.length());
                                }
			}
